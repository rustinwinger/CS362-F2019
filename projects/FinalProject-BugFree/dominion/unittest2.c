...
int main() {
	...
	printf("\n\n******************BEGIN TEST MINE CARD: TRYING TO TRADE COPPER FOR GOLD****************\n\n");
	...
	int result = cardEffect(11, choice1, choice2, 0, &testG, handPos, 0);
	...
	if (costDiff > maxCostDiff) {
		printf("Choice 2 costs more than 3 more coins than choice 1: PASSED\n");
	}
	else {
		printf("Choice 2 costs more than 3 more coins than choice 1: FAILED\n");
	}
