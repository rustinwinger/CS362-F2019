...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
		mine(currentPlayer, state, choice1, choice2, handPos);
        return 0;
    ...
    case baron:
		baron(currentPlayer, state, choice1);
        return 0;
    ...
    case minion:
		minion(currentPlayer, state, choice1, choice2, handPos);
        return 0;
    ...
    case tribute:
		tribute(currentPlayer, state, nextPlayer);
        return 0;

    case ambassador:
		ambassador(currentPlayer, state, choice1, choice2, handPos);
        return 0;
...
int baron(int currentPlayer, struct gameState *state, int choice1) {
...
int minion(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos) {
	//+1 action
	state->numActions++;
	int i, j;
...
int tribute(int currentPlayer, struct gameState *state, int nextPlayer) {
...
int mine(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos) {
	int i, j;
